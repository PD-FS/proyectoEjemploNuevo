...
class BloodTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create blood_type" do
    assert_difference('BloodType.count') do
      post blood_types_url, params: { blood_type: { group: @blood_type.group, hasHIV: @blood_type.hasHIV, rh: @blood_type.rh } }
    end
  ...
  test "should update blood_type" do
    patch blood_type_url(@blood_type), params: { blood_type: { group: @blood_type.group, hasHIV: @blood_type.hasHIV, rh: @blood_type.rh } }
